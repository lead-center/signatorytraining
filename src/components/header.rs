          ...
          <ul class="flex items-center gap-4">
            ...
            if user.is_some() {
              ...
              <>
                ...
                <li>
                  <Link<Route> to={Route::RegisterPage} classes="text-ct-dark-600">{"Register"}</Link<Route>>
                </li>
                <li>
                  <Link<Route> to={Route::SignatoryTrainingPage} classes="text-ct-dark-600">{"Signatory Training"}</Link<Route>>
                </li>
              </>
            }
          </ul>
